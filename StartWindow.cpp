	...
	: QMainWindow(parent)
{
	...
	button->setGeometry(QRect(QPoint(350, 100), QSize(100, 30)));
	connect(button, &QPushButton::clicked, this, &StartWindow::Startgame);
		...
		widthInput->setGeometry(QRect(QPoint(50, 100), QSize(100, 30)));
		...
		heightInput->setGeometry(QRect(QPoint(150, 100), QSize(100, 30)));
		...
		mineNumbers->setGeometry(QRect(QPoint(250, 100), QSize(100, 30)));
